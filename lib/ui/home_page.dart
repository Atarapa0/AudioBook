...
class _HomePageState extends State<HomePage>
  ...
  void navigateToAudioPage(Map<String, dynamic> bookData) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AudioPage(bookData: bookData),      ),
    );
  }
  ...
  Widget buildBookItem(Map<String, dynamic> bookData, {bool isReversed = false}) {
    return GestureDetector(
      onTap: () => navigateToAudioPage(bookData),
      child: Container(
                    ...
                    Positioned(
                      ...
                      child: SizedBox(
                        ...
                        child: PageView.builder(
                          ...
                          itemBuilder: (_, index) {
                            return GestureDetector(
                              onTap: () => navigateToAudioPage(populerBooks![index]),
                              child: Container(
                                height: 180,
                  ...
                  body: TabBarView(
                    ...
                    children: [
                      ListView.builder(
                        ...
                        itemBuilder: (_, index) => buildBookItem(books![index]),
                      ),
                      ListView.builder(
                        itemCount: books?.length ?? 0,
                        itemBuilder: (_, index) {
                          int reverseIndex = (books!.length - 1) - index;
                          return buildBookItem(books![reverseIndex], isReversed: true);
                        },
                      ),
                      ListView.builder(
                        itemCount: books?.length ?? 0,
